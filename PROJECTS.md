...
| AttendFlow AI | 🟢 Live | attendflow-ai.vercel.app | github.com/Jayronj0616/AttendFlow_Ai | Personal project. AI-assisted attendance correction — deterministic business rules (not the AI) decide auto-apply vs. escalate to HR, full audit trail. Deployed and verified in production per the project's own `docs/progress.md`; the natural-language extraction step is currently a documented placeholder pending an LLM key — everything downstream of it already works. Cover image pending — Jayron is capturing his own screenshots (folder reserved at `public/images/attendflow/`). |
