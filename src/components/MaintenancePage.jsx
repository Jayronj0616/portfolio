...
export default function MaintenancePage() {
  ...
  return (
    <main className="bg-mesh flex min-h-screen flex-col items-center justify-center bg-background px-6 text-center text-foreground">
      <div className="flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-accent to-accent-2 text-sm font-semibold tracking-wide text-white">
        {initials}
      </div>

      <span className="mt-6 flex items-center gap-2 rounded-full border border-border bg-surface px-4 py-1.5 text-xs font-medium uppercase tracking-widest text-accent">
